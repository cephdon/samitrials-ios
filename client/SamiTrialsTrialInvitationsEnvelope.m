...
@implementation SamiTrialsTrialInvitationsEnvelope
...
-(id) initWithValues:(NSDictionary*)dict
{
    ...
    if(self) {
        ...
        if(data_dict != nil)
            _data = [[SamiTrialsTrialInvitationArray  alloc]initWithValues:data_dict];
...
-(NSDictionary*) asDictionary {
    ...
    if(_data != nil){
        if([_data isKindOfClass:[NSArray class]]){
            ...
            for( SamiTrialsTrialInvitationArray *data in (NSArray*)_data) {
