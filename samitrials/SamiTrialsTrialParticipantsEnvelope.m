...
@implementation SamiTrialsTrialParticipantsEnvelope
...
-(id) initWithValues:(NSDictionary*)dict
{
    ...
    if(self) {
        ...
        if(data_dict != nil)
            _data = [[SamiTrialsTrialParticipantArray  alloc]initWithValues:data_dict];
...
-(NSDictionary*) asDictionary {
    ...
    if(_data != nil){
        if([_data isKindOfClass:[NSArray class]]){
            ...
            for( SamiTrialsTrialParticipantArray *data in (NSArray*)_data) {
