...
@implementation SamiTrialsConnectedDevicesEnvelope
...
-(id) initWithValues:(NSDictionary*)dict
{
    ...
    if(self) {
        ...
        if(data_dict != nil)
            _data = [[SamiTrialsConnectedDeviceArray  alloc]initWithValues:data_dict];
...
-(NSDictionary*) asDictionary {
    ...
    if(_data != nil){
        if([_data isKindOfClass:[NSArray class]]){
            ...
            for( SamiTrialsConnectedDeviceArray *data in (NSArray*)_data) {
