...
@implementation SamiTrialsTrialAdministratorsEnvelope
...
-(id) initWithValues:(NSDictionary*)dict
{
    ...
    if(self) {
        ...
        if(data_dict != nil)
            _data = [[SamiTrialsTrialAdministratorArray  alloc]initWithValues:data_dict];
...
-(NSDictionary*) asDictionary {
    ...
    if(_data != nil){
        if([_data isKindOfClass:[NSArray class]]){
            ...
            for( SamiTrialsTrialAdministratorArray *data in (NSArray*)_data) {
